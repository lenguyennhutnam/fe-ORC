...
export const fetchModelProviders: Fetcher<{ data: any[] }, string> = (url) => {
...
export const fetchModelProviderModelList: Fetcher<{ data: any[] }, string> = (url) => {
  return get<{ data: any[] }>(url)
}

export const fetchModelList: Fetcher<{ data: any[] }, string> = (url) => {
  return get<{ data: any[] }>(url)
}
...
export const fetchDefaultModal: Fetcher<{ data: any }, string> = (url) => {
  return get<{ data: any }>(url)
}
...
export const fetchModelParameterRules: Fetcher<{ data: any[] }, string> = (url) => {
  return get<{ data: any[] }>(url)
}
...
export const getSystemFeatures = () => {
  return get<any>('/system-features')
}

export const enableModel = (url: string, body: { model: string; model_type: any }) =>
  patch<CommonResponse>(url, { body })

export const disableModel = (url: string, body: { model: string; model_type: any }) =>
  patch<CommonResponse>(url, { body })
