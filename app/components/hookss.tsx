...
import { buildChatItemTree } from './chat/utils'
...
export const useChatWithHistory = (installedAppInfo?: any) => {
  ...
  const [originConversationList, setOriginConversationList] = useState<any[]>([])
  useEffect(() => {
  ...
  const currentConversationItem = useMemo(() => {
    ...
    if (!conversationItem && pinnedConversationList.length)
      conversationItem = pinnedConversationList.find((item: any) => item.id === currentConversationId)
