...
// import type { DataSet } from '@app/models/datasets'
// import type { ExternalDataTool } from '@app/models/common'
...
//     if (promptEmpty) {
//       Toast.notify({ type: 'error', message: t('appDebug.otherError.promptNoBeEmpty') })
//       return
//     }
...
//     }
//     if (contextVarEmpty) {
//       Toast.notify({ type: 'error', message: t('appDebug.feature.dataSet.queryVariable.contextVarNotEmpty') })
//       return
//     }
