...
export type AppDetailResponse = any
...
export type AppSSOResponse = { enabled: any['enable_sso'] }

export type AppTemplatesResponse = {
  data: any[]
}

export type CreateAppResponse = any

export type UpdateAppSiteCodeResponse = { app_id: string } & any
